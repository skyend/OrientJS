...
class APIRequest {
  ...
  request(_apiSourceDesc, _requestId, _paramObject, _callback, _enctype, _methodOverride, _use_ssl,_withCredential) {

    APIRequest.RequestAPI(this.env, this.env.interpret(_apiSourceDesc), this.env.interpret(_requestId), _paramObject, _callback, _enctype, _methodOverride, _use_ssl,_withCredential);
  }

  requestSync(_apiSourceDesc, _requestId, _paramObject, _callback, _enctype, _methodOverride, _use_ssl,_withCredential) {
    APIRequest.RequestAPISync(this.env, this.env.interpret(_apiSourceDesc), this.env.interpret(_requestId), _paramObject, _callback, _enctype, _methodOverride, _use_ssl,_withCredential);
  }

  static RequestAPISync(_env, _apiSourceDesc, _requestId, _paramObject, _callback, _enctype, _methodOverride, _use_ssl, _withCredential) {
    ...
    if (/^https?$/.test(sourceType)) {
      ...
      }, _enctype, _use_ssl, _withCredential);
    } else {
  ...
  static RequestAPI(_env, _apiSourceDesc, _requestId, _paramObject, _callback, _enctype, _methodOverride, _use_ssl,_withCredential) {
