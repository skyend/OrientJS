...
var Lobby = React.createClass({
  ...
  newProject () {
    var name = this.refs['field-new-project-name']
      .getDOMNode()
      .value;
    if (!/^[\w\s]+$/.test(name)) 
  ...
  newService () {
    var name = this.refs['field-new-service-name']
      .getDOMNode()
      .value;
    if (!/^[\w\s]+$/.test(name)) 
      return this.setState({
        message: '서비스명을 입력해 주세요.'
      });
  ...
  renderServiceItem (_service) {
    ...
    return (
      <li onClick={function() {
        self.startServiceBuilding(_service._id)
      }}>
        ...
        <div className='row-division'>
          <form method="post" action="#">
            ...
            <ul className="actions">
              <li>
                <a href="#" className="button" onClick={this.newProject}>add new Project</a>
              </li>
            </ul>
          </form>
        </div>
      ...
      <div className='column'>
        <div className='row-division'>
          <form method="post" action="#">
            ...
            <ul className="actions">
              <li>
                <a href="#" className="button" onClick={this.newService}>add new Service</a>
              </li>
            </ul>
          </form>
        </div>
