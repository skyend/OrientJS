...
var SignUp = React.createClass({
  ...
  submit () {
    var id = this.refs['field-id']
      .getDOMNode()
      .value;
    var email = this.refs['field-email']
      .getDOMNode()
      .value;
    var name = this.refs['field-name']
      .getDOMNode()
      .value;
    var password = this.refs['field-password']
      .getDOMNode()
      .value;
    var conPassword = this.refs['field-con-password']
      .getDOMNode()
      .value;
    ...
    this.setState({
      'message': <span>처리중입니다.<i className='fa fa-spinner fa-spin'/></span>
    });
  ...
  failSignUp () {
    this.setState({
      'message': <span>회원가입 실패. 일단 관리자에게 문의하세요.</span>
    });
  },
      ...
      <section id="main">
        ...
        <form method="post" action="#">
          ...
          <ul className="actions">
            <li>
              <a href="#" className="button" onClick={this.cancel}>Cancel</a>
            </li>
            <li>
