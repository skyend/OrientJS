...
(function () {
    ...
    var ToolNavigation = React.createClass({
        ...
        naviItemRender(_menuItem){
            ...
            return (
                <li title={_menuItem.title} className={classes.join(' ')} onClick={function(e){ self.clickNaviItem(e, _menuItem); }}>
        ...
        toolRender( _tool ) {
           ...
           if(  _tool !== null && typeof _tool === 'object') {
             ...
             headElement = <i className={"fa fa-"+menuInfo.icon}> {menuInfo.title}</i>;
               ...
               toolElement = <div className='error'> <span className='message'>Not Tool rendered</span> </div>;
               headElement = "unknown";
            }
