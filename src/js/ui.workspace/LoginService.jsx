              ...
              <div className="main-login-form">
                <div className="login-group">
                  ...
                  <div className="form-group" onKeyDown={this.enterLoginProcess}>
                    <input id="log-password" type="password" className="form-control"
                ...
                <button id="login-button" type="button" className="login-button"
              ...
              <form id="login-form" className="login-form">
                ...
                <div className="main-login-form">
                  <div className="login-group">
                    ...
                    <div className="form-group">
                      <input type="text" className="form-control" id="reg-fullName"
                  ...
                  <button id="register-button" type="button" className="login-button"
                          onClick={this.registerProcess}>
                    <i className="fa fa-chevron-right"></i>
                  </button>
                </div>
                <div className="etc-login-form">
            ...
            <div className="text-center">
              ...
              <form id="login-form" className="login-form">
                ...
                <div className="main-login-form">
                  <div className="login-group">
                    <div className="form-group">
                      <input id="forgot-email" type="text" className="form-control"
                             placeholder="email address"/>
                    </div>
                  </div>
                  <button id="forgot-pass-button" type="button" className="login-button"
                          onClick={this.forGotPassProcess}>
                    <i className="fa fa-chevron-right"></i>
                  </button>
                </div>
                <div className="etc-login-form">
