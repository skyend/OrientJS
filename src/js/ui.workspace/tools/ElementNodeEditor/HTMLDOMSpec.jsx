  ...
  render() {
    ...
    return (
      <div className={rootClasses.join(' ')}>
        <HorizonFieldSet title="DOM 명세표" theme={ this.props.theme} nameWidth={130}
                         fields={ elementSpecFieldSet } ref='elementDOMSpec'/>
        {elementNode.getType() !== 'string' ?
          <HorizonFieldSet title="Tag 지원 속성" theme={ this.props.theme} nameWidth={130}
                           fields={ tagAttributeFieldSet } ref='tagAttribute'/> : ''}
        {elementNode.getType() !== 'string' ?
          <HorizonFieldSet title="Tag 명시 데이터" theme={ this.props.theme} nameWidth={130}
                           fields={ dataAttributeFieldSet } extendable={true} ref='dataAttribute'/> : ''}
      </div>
    );
  }
});
