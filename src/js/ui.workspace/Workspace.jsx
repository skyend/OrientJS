...
var Workspace = React.createClass({
  ...
  onThrowCatcherSelectElementNode (_eventData, _pass) {
    this.refs['DocumentStage']
      .selectElementNode(_eventData.elementNode);
  },
  ...
  onThrowCatcherMouseEnterElementNode (_eventData, _pass) {
    this.refs['DocumentStage']
      .mouseEnterElement(_eventData.elementNode);
  },

  onThrowCatcherMouseLeaveElementNode (_eventData, _pass) {
    this.refs['DocumentStage']
      .mouseLeaveElement(_eventData.elementNode);
  },
  ...
  resizeDocumentStage () {
    var documentStage = this.refs['DocumentStage'];
    var headToolBarDOM = this.refs['HeadToolBar']
      .getDOMNode();
    var leftNavigationDOM = this.refs['LeftNavigation']
      .getDOMNode();
    var rightNavigationDOM = this.refs['RightNavigation']
      .getDOMNode();
    var bottomNavigationDOM = this.refs['BottomNavigation']
      .getDOMNode();

    documentStage.setState({
      width: this.getDOMNode()
        .offsetWidth - leftNavigationDOM.offsetWidth - rightNavigationDOM.offsetWidth,
      height: this.getDOMNode()
        .offsetHeight - headToolBarDOM.offsetHeight - bottomNavigationDOM.offsetHeight,
    ...
    return (
      <div className='workspace'>
        <div className='editor-floor-supporters'>
          ...
          <ToolNavigation ref="LeftNavigation" defaultToolSize={310} maxSize={700} naviSize={45} fontSize={22} config={this.props.LeftNavigationConfig} initialShow={true} showTitle={false} showIcon={true} theme='dark' verticalText={true} position='left'/>

          <ToolNavigation ref="RightNavigation" defaultToolSize={410} maxSize={700} naviSize={45} fontSize={22} config={this.props.RightNavigationConfig} initialShow={true} showTitle={false} showIcon={true} theme='dark' verticalText={true} position='right'/>

          <ToolNavigation ref="BottomNavigation" defaultToolSize={310} maxSize={700} naviSize={27} config={this.props.BottomNavigationConfig} initialShow={false} showTitle={true} showIcon={true} closeable={true} theme='dark' verticalText={true} position='bottom'/>

          <DocumentStage ref='DocumentStage' aimingCount={100} aimingEscapeStepSize={10} boundaryBorderSize={5}/>
