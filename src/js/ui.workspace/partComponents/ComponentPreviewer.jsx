...
var ComponentPreviewer = React.createClass({
  ...
  renderComponent () {
    ...
    if (typeof this.state.componentSource === 'object') {
      if (typeof this.state.componentSourceType === 'undefined') 
        throw new Error("Need a componentSourceType.");
      }
  ...
  componentDidUpdate (_prevState, _prevProps) {
    var invisibleRenderedComponent = this.refs['invisible-prerender-box']
      .getDOMNode();
    ...
    return (
      <div className={classes.join(' ')} style={style}>
        <div className='render-area'>
          ...
          <IFrameStage ref='render-stage' src='about:blank' width={this.props.width} height={this.props.height}/>

          <div className="component-view-wrap"></div>
