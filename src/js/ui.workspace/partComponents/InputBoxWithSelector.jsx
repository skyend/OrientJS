            ...
            return (
                <div className={classes.join(' ')}>
                    <div className="input-wrapper">
                        <input autoComplete="off" className={this.props.dontEnter? 'clickable':''}
                               onClick={this.inputClick} onKeyUp={this.onKeyUp} onChange={this.changedValue} ref='input'
                               disabled={this.props.dontEnter}/>
