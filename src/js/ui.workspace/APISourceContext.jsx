...
var Request = React.createClass({
  ...
  renderFillFieldsFromNodeType(){
    ...
    return propertyTypes.map(function (_pt, _i) {
      ...
      return <div className='field'>
        ...
        <input placeholder="Test value" value={testFieldPlaceHolders[_pt.pid]}
               onChange={function(_e){  self.changeFieldTestValue(_pt.pid,_e); }}/>
      </div>
    })
  },
  ...
  renderRows(){
    ...
    return [<div className='row'>
      ...
      {this.renderWithCheckEditable(<select onChange={this.changeCRUD}
                                            value={this.props.request.crud.toUpperCase()} ref='crud-selector'>
        ...
        <div className='request-field-set'>
          <div className='configs'>
            <div className='config'>
              {this.renderWithCheckEditable(<button onClick={this.addNewHeader}> Header <i
          ...
          { this.props.request.headerList.map(function (_header, _i) {
            ...
            return <div className='field'>
              <input placeholder="Header name (a-z,_,-)" value={_header.name}
                     onChange={function(_e){ self.changeHeaderName(_i,_e); }}/>
              <i className='fa fa-long-arrow-right'/>
              <input placeholder="Header value or resolver" value={_header.value}
                     onChange={function(_e){ self.changeHeaderValue(_i,_e); }}/>
              <i className='fa fa-ellipsis-v'/>
              <input placeholder="Test value" value={_header.testValue}
                     onChange={function(_e){ self.changeHeaderTestValue(_i,_e); }}/>
              { self.renderWithCheckEditable(<button onClick={function(){self.deleteHeader(_i)}}>
                Delete</button>) }
            </div>
          })}
        ...
        <div className='request-field-set'>
          <div className='configs'>
            <div className='config'>
              ...
              <CheckBox value={this.props.request.fieldFillFromNodeType||false}
                        onToggle={this.fillFromPropertytypesToggle}/>
            </div>
            <div className='config'>
              {this.renderWithCheckEditable(<button onClick={this.addNewField}> Field <i
                className='fa fa-plus'/></button>)}
            </div>
          </div>
          ...
          { this.props.request.fieldList.map(function (_field, _i) {
            return <div className='field'>
              <input placeholder="Field name (a-z,_,-)" value={_field.name}
                     onChange={function(_e){ self.changeFieldName(_i,_e); }}/>
              <i className='fa fa-long-arrow-right'/>
              <input placeholder="Field value or resolver" value={_field.value}
                     onChange={function(_e){ self.changeFieldValue(_i,_e); }}/>

              {self.props.isInterface ? '' : [<i className='fa fa-ellipsis-v'/>,
                <input placeholder="Test value" value={testFieldPlaceHolders[_field.name]}
                       onChange={function(_e){ self.changeFieldTestValue(_field.name,_e); }}/>]}
              {self.renderWithCheckEditable(<button onClick={function(){self.deleteField(_i)}}>
                Delete</button>)}
            </div>
          })}
