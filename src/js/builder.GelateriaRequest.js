...
class GelateriaRequest {
  ...
  savePage(_serviceId, _page_id, _pageDataObject, _complete) {
    console.log('do save');
    request.post("http://localhost:8080/" + ["pages", 'save'].join("/"))
      .type('form')
      .withCredentials()
      .send({
        service_real_id: _serviceId,
  ...
  saveAPISource(_service_real_id, _apisource_id, _apisourceDataObject, _complete) {
    request.post("http://localhost:8080/" + ["apisources", 'save'].join("/"))
      .type('form')
      .withCredentials()
      .send({
        service_real_id: _service_real_id,
  ...
  createAPIInterface(_serviceId, _title, _complete) {
    console.log('create');
    request.post("http://localhost:8080/" + ["apiinterfaces", 'create'].join("/"))
      .type('form')
      .withCredentials()
      .send({
        serviceId: _serviceId,
  ...
  getAPIInterfaceList(_serviceId, _complete) {
    request.post('http://localhost:8080/' + ['apiinterfaces', 'list'].join('/'))
      .type('form')
      .withCredentials()
      .send({
        serviceId: _serviceId,
  ...
  loadApiinterface(_service_real_id, _apiinterfaceId, _complete) {
    console.log("Service REAL ID", _service_real_id);
    request.post("http://localhost:8080/apiinterfaces/" + ["retrieve"].join("/"))
      .type('form')
      .withCredentials()
      .send({
        'service_real_id': _service_real_id,
  ...
  saveAPIInterface(_service_real_id, _apiinterface_id, _apiinterfaceDataObject, _complete) {
    request.post("http://localhost:8080/" + ["apiinterfaces", 'save'].join("/"))
      .type('form')
      .withCredentials()
      .send({
        service_real_id: _service_real_id,
